...
describe('xotp', function () {
  describe('data:', function () {
    describe('should throw error:', function () {
      it('when data type is not Uint8Array', function () {
        assert.throws(
          () => xotp('not a binary data', Buffer.alloc(32)),
  ...
  describe('key:', function () {
    describe('should throw error:', function () {
      it('when key is not Uint8Array', function () {
        ...
        assert.throws(
          () => xotp(originData, 'not a binary key'),
  ...
  describe('otpStartIndex:', function () {
    it('should throw error:', function () {
      assert.throws(
        () => xotp(Buffer.from('encoded data'), Buffer.alloc(32), '2332'),
  ...
  describe('sharedDataBuffer:', function () {
    describe('should throw error:', function () {
      it('when type is not boolean', function () {
        assert.throws(
          () => xotp(Buffer.from('encoded message is okay.'), Buffer.alloc(32), 0, 'not boolean'),
    ...
    describe('if sharedDataBuffer parameter is', function () {
      ...
      describe('if false(default)', function () {
        it('should return new buffer. can not modified.', function () {
          ...
          const result = xotp(originData, keyBuffer, 0, false) // default  false
          // not equal
      ...
      describe('if true', function () {
        it('should return shared buffer.', function () {
          ...
          const result = xotp(originData, keyBuffer, 0, true) // shared
